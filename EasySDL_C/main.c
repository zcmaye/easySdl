...
int main(int argc, char* argv[])
{
	...
	while (1)
	{
		...
		////drawEllipse(renderer(), &color, 50, 50, 100,120);
		//drawCircle(renderer(), 100, 100, 80);
		//drawArc(renderer(), 150, 150, 50, 1.5,2.0);

		drawFillEllipse(renderer(), &color, 150, 50, 250, 120);
		drawFillCircle(renderer(), 200, 300, 500);
